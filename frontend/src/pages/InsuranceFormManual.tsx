                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-auto-only-manual" value="Only Auto Insurance" />
                      <Label htmlFor="ins-auto-only-manual" className="font-normal">Only Auto Insurance</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-home-tenant-only-manual" value="Only Home/Tenant Insurance" />
                      <Label htmlFor="ins-home-tenant-only-manual" className="font-normal">Only Home/Tenant Insurance</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-auto-tenant-manual" value="Auto plus Tenant Insurance" />
                      <Label htmlFor="ins-auto-tenant-manual" className="font-normal">Auto plus Tenant Insurance (Save upto 20% Extra)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-auto-home-manual" value="Auto plus Home Insurance" />
                      <Label htmlFor="ins-auto-home-manual" className="font-normal">Auto plus Home Insurance (Save upto 20% Extra)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-auto-home-rental-manual" value="Auto Plus Home Plus Rental Insurance" />
                      <Label htmlFor="ins-auto-home-rental-manual" className="font-normal">Auto Plus Home Plus renatal insurance (Save 20% Extra)</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem id="ins-rental-only-manual" value="Only Rental property Insurance" />
                      <Label htmlFor="ins-rental-only-manual" className="font-normal">Only Rental property Insurance</Label>
                    </div>
                  </RadioGroup>
                </div>
                <div className="space-y-2">
