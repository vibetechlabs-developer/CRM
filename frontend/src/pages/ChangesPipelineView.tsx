...
import { Plus, SlidersHorizontal, CheckCircle, Clock, Trash2, X, Download } from "lucide-react";
    ...
    <div className="space-y-6 h-full flex flex-col">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 shrink-0">
        <div className="min-w-0 flex-shrink">
          <h1 className="text-2xl font-bold truncate">Changes Pipeline</h1>
          <p className="text-muted-foreground text-sm mt-0.5 truncate">Manage and track changes requests</p>
        </div>
          ...
          <div className="flex items-center gap-3">
            <Button 
              ...
              onClick={() => {
                ...
                exportTicketsToCSV(completedTickets, "changes_tickets_completed.csv");
              }}
            >
